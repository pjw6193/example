...
public class WrapperClassesGenerics {
	...
	public static void main(String[] args) {
		...
		// sorted collections: maintains an order based sorting algorithm (natural order, another order)
		// unordered, not sorted
		Set<Lion> circus = new HashSet<>();
		// sorted collection: natural order (Comparable.compareTo) OR comparator (Comparator.compare)
...
class LionAgeComparator implements Comparator<Lion> {
